...
define("reanimator/plugins/jquery-3.2.0", function(){});

define('reanimator-jquery.3.2.0',['require','exports','module','jquery-3.2.0','reanimator/plugins/jquery-3.2.0'],function (require, exports, module) {/* vim: set et ts=2 sts=2 sw=2: */

require('jquery-3.2.0');
require('reanimator/plugins/jquery-3.2.0');

});

require("reanimator-jquery.3.2.0");
}(this))